namespace Testinator.Core
{
    ...
    public static class QuestionHelpers
    {
        ...
        public static bool IsAnswerCorrect(this MultipleChoiceQuestion question, MultipleChoiceAnswer answer)
        {
            return question.CorrectAnswerIndex == answer.SelectedAnswerIdx;
        }
        ...
        /// <param name="answer">The answer to check</param>
        /// <returns>True is correct, false otherwise</returns>
        public static bool IsAnswerCorrect(this SingleTextBoxQuestion question, SingleTextBoxAnswer answer)
        {
